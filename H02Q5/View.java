...
public class View extends JFrame implements ActionListener {
 ...
 public View() {
	 ...
	 panelFunctButton = new JPanel();
	 panelFunctButton.setLayout(new GridLayout(2,2));
	 panelFunctButton.addButton("x^y");
	 panelFunctButton.addButton("log 10");
	 panelFunctButton.addButton("log e");
	 panelFunctButton.addButton("sqrt");
	 ...
	 panelSysButton = new JPanel();
	 panelSysButton.setLayout(null);
	 panelSysButton.addButton("Clear");
	 panelSysButton.addButton("About");
	 panelSysButton.addButton("Exit");
	 ...
	 panelFunctSys = new JPanel();
	 panelFunctSys.setLayout(new BorderLayout());
	 add.panelFunctButton.panelFunctSys(CENTER);
	 add.panelSysButton.panelFunctSys(SOUTH);
	 ...
	 panelKeypad.addButton("7"); 
	 panelKeypad.addButton("8");
	 panelKeypad.addButton("9");
	 panelKeypad.addButton("/");
	 panelKeypad.addButton("4");
	 panelKeypad.addButton("5");
	 panelKeypad.addButton("6");
	 panelKeypad.addButton("*");
	 panelKeypad.addButton("1");
	 panelKeypad.addButton("2");
	 panelKeypad.addButton("3");
	 panelKeypad.addButton("-");
	 panelKeypad.addButton("0");
	 panelKeypad.addButton(".");
	 panelKeypad.addButton("+/-");
	 panelKeypad.addButton("+");
	 ...
	 panelBottom.add.panelKeypad.setLayout(new BoxLayout(HORIZONTAL));
	 panelBottom.Box.createRigidArea(10);
	 ...
	 panelTextField.setLayout(null);
	 label = new JLabel("Kalkutron-9000");
	 ...
	 panelMain.setLayout(new BoxLayout(VERTICAL));
	 panelMain.Box.createVerticalGlue();
  ...
  */
 @Override
 public void actionPerformed(ActionEvent pEvent) implements ActionListener() {
